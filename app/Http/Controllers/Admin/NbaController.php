...
class NbaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.trades.nba.nba_trade_list', compact('trades'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.trades.nba.add_nba_trade', compact('events', 'clients'));
    }
    ...
    public function store(TradeRequest $request)
    {
        ...
        if ($balance <= 0) {
            ...
            return redirect()->route('nba-trades.index')->with($notification);
        }
    }
