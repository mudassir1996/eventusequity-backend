...
class TableTennisController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.trades.table_tennis.table_tennis_trade_list', compact('table_tennis_trades'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.trades.table_tennis.add_table_tennis_trade', compact('events', 'clients'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($balance <= 0) {
            ...
            return redirect()->route('table-tennis-trades.index')->with($notification);
        }
    }
