...
class UfcController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.trades.ufc.ufc_trade_list', compact('trades'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.trades.ufc.add_ufc_trade', compact('events', 'clients'));
    }
    ...
    public function store(TradeRequest $request)
    {
        ...
        if ($balance <= 0) {
            ...
            return redirect()->route('ufc-trades.index')->with($notification);
        }
    }
