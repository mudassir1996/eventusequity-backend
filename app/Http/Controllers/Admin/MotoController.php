...
class MotoController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.trades.moto.moto_trade_list', compact('motoTrades'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.trades.moto.add_moto_trade', compact('events', 'clients'));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(MotoTradeRequest $request)
    {
        ...
        if ($balance <= 0) {
            ...
            return redirect()->route('moto-trades.index')->with($notification);
        }
    }
    ...
    public function edit($id)
    {
        ...
        $trade = Trade::find($id);
        $clients = User::where('is_admin', 0)->latest()->select('first_name', 'last_name', 'id')->get();
        return view('admin.trades.moto.edit_moto_trade', compact('events', 'trade', 'clients'));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(MotoTradeRequest $request, $id)
    {
        $trade = Trade::find($id);
