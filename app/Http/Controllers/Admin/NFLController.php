...
class NFLController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.trades.nfl.nfl_trade_list', compact('trades'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.trades.nfl.add_nfl_trade', compact('events', 'clients'));
    }
    ...
    public function store(TradeRequest $request)
    {
        ...
        if ($balance <= 0) {
            ...
            return redirect()->route('nfl-trades.index')->with($notification);
        }
    }
    ...
    public function edit($id)
    {
        ...
        $trade = Trade::find($id);
        $clients = User::where('is_admin', 0)->latest()->select('first_name', 'last_name', 'id')->get();
        return view('admin.trades.nfl.edit_nfl_trade', compact('events', 'trade', 'clients'));
    }
