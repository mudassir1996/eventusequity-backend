                ...
                <div class="col-xl-6">
                    <div class="page_title-content">
                        <p class="mb-0">
                            ...
                            <span>/</span>
                            <span>Add Table Tennis Trade</span>
                        </p>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" action="{{ route('table-tennis-trades.store') }}" name="myform"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-xl-6">
                                        <label class="mr-sm-2">Player One</label>
                                    ...
                                    <div class="form-group col-xl-6">
                                        <label class="mr-sm-2">Player One Score</label>
                                        <input type="number" class="form-control" required placeholder="Enter Score"
                                    ...
                                    <div class="form-group col-xl-6">
                                        <label class="mr-sm-2">Player Two</label>
                                        <select class="form-control" id="team_two" required name="team_two_id">
                                            <option value="">--choose team--</option>

                                        </select>
                                        @error('team_two_id')
                                            <label id="team_two_id-error" class="error"
                                                for="team_two_id">{{ $message }}</label>
                                        @enderror
                                    </div>

                                    <div class="form-group col-xl-6">
                                        <label class="mr-sm-2">Player Two Score</label>
                                        <input type="number" class="form-control" required placeholder="Enter Score"
                                            value="{{ old('team_two_score') }}" name="team_two_score">
                                        @error('team_two_score')
                                            <label id="team_two_score-error" class="error"
                                                for="team_two_score">{{ $message }}</label>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-xl-6">
                                        ...
                                        <select class="form-control" required name="result">
                                            ...
                                            <option value="win" {{ old('result') == 'win' ? 'selected' : '' }}>Win
                                            </option>
                                            <option value="lose" {{ old('result') == 'lose' ? 'selected' : '' }}>Lose
                                            </option>
                                        </select>
                                        @error('result')
