        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{route('nrl-trades.update', $trade->id)}}" name="myform" class="personal_validate" novalidate="novalidate" enctype="multipart/form-data">
                            @csrf
                            @method("PATCH")
                            <div class="form-row">
                                ...
                                <div class="form-group col-xl-6">
                                    ...
                                    <input type="number" class="form-control" required placeholder="Enter Score" value="{{$trade->team_one_score}}" name="team_one_score">
                                ...
                                <div class="form-group col-xl-6">
                                    ...
                                    <option value="">--choose team--</option>
                                    @foreach($teams as $team)
                                        <option value="{{$team->id}}" {{$trade->team_two_id==$team->id ? 'selected' : ''}}>
                                            {{$team->team_name}}
                                        </option>
                                    @endforeach
                                ...
                                <div class="form-group col-xl-6">
                                    ...
                                    <input type="number" class="form-control" required placeholder="Enter Score" value="{{$trade->team_two_score}}" name="team_two_score">
                                ...
                                <div class="form-group col-xl-6">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Trade" value="{{$trade->notes}}" name="notes">
                                    @error('notes')
