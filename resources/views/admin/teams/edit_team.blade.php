        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{route('teams.update', $team->id)}}" name="myform" class="personal_validate" novalidate="novalidate" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            <div class="form-row">
                                <div class="form-group col-xl-12">
                                    <label class="mr-sm-2">Team Name</label>
                                    <input type="text" class="form-control" required placeholder="Barcelona" value="{{$team->team_name}}" name="team_name">
                                    @error('team_name')
                                ...
                                <div class="form-group col-xl-12">
                                    ...
                                    <select class="form-control" required name="event_id">
                                        ...
                                        @foreach ($events as $id => $event)
                                            <option value="{{$id}}" {{$team->event_id==$id?'selected':''}}>{{$event}}</option>
                                        @endforeach
                                    </select>
                                    @error('event_id')
                                ...
                                <div class="form-group col-xl-12 mt-5">
                                    <div class="media align-items-center mb-3">
                                        <img class="mr-3 rounded-circle mr-0 mr-sm-3"
                                            src="{{Storage::disk('public')->exists('teams/'.$team->team_img)?$image=asset('storage/teams/'.$team->team_img):$image=asset('images/'.$team->team_img)}}" id="uploaded" width="55" height="55" alt="">
