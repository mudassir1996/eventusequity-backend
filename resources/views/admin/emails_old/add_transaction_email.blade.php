            ...
            background-color: #fff; overflow: hidden;border-bottom: 1px solid #E2E2E2;">
             ...
             font-family: 'Product sans bold;line-height: 1.5;">
                                                        <h1
                                                            ...
                                                            <span
                                                                style="font-weight:500;">{{ $transaction_data['transaction_type'] == 'withdraw' ? 'Withdrawal Requested' : 'Deposit Successful' }}</span>
                                                        </h1>
               ...
               margin-bottom: 10px !important;font-size: 16px; color: #000;font-family: 'Product sans', sans-serif;">
                                                                {{ ucfirst($transaction_data['full_name']) }} your
                                                                payment of <span
                                                                    style="color: {{ config('email_template.primary_color') }};">£{{ number_format($transaction_data['transaction_amount'], 2) }}</span>
                                                                has been confirmed with {{ env('APP_NAME') }}.
                                                            </p>
                                                            <p class="mobile-p" align="left" style="font-weight: 400; margin-top:15px;
               margin-bottom: 10px !important;font-size: 16px; color: #000;font-family: 'Product sans', sans-serif;">
                                                                It has now been added to your trading account with
                                                                {{ env('APP_NAME') }}.
                                                            </p>
               ...
               margin-bottom: 10px !important;font-size: 16px; color: #000;font-family: 'Product sans', sans-serif;">
                ...
                margin-bottom: 10px !important;font-size: 16px; color: #000;font-family: 'Product sans', sans-serif;">
                                                                ...
                                                                Withdrawal of <span
                                                                    style="color: {{ config('email_template.primary_color') }};">£{{ number_format($transaction_data['transaction_amount'], 2) }}</span>
                                                                has been initiated with {{ env('APP_NAME') }}.
                                                            </p>
                                                            <p class="mobile-p" align="left" style="font-weight: 400; margin-top:15px;
                margin-bottom: 10px !important;font-size: 16px; color: #000;font-family: 'Product sans', sans-serif;">
                ...
                margin-bottom: 10px !important;font-size: 16px; color: #000;font-family: 'Product sans', sans-serif;">
                                                ...
                                                {{-- <tr>
													...
													font-family: 'Product sans bold', sans-serif;line-height: 1.5;">
														...
														<a class = "btn-start" href = "{{route('login')}}" style = "max-width: 220px;border-radius: 6px;background-color: {{ config('email_template.primary_color') }};border:1px solid {{ config('email_template.primary_color') }};color:#fff;padding: 15px 25px;font-weight: 700;font-size:16px;">
														...
														<!--[if mso]>
															  <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="#" style="height:45px;v-text-anchor:middle;width:220pt; padding-top:10px;padding-bottom:10px; padding-left:25px;padding-right:25px;" arcsize="25%" strokecolor="{{ config('email_template.primary_color') }};" fillcolor="{{ config('email_template.primary_color') }};">
																<w:anchorlock/>
             ...
             verdana, sans-serif;line-height: 1.5; font-weight:400;">
               ...
               margin-block-start: 0px;border:1px solid #dbdbdb;border-bottom: none;">
                   ...
                   margin-bottom: 5px !important;font-size: 14px; color: #626262;font-family: 'Product sans', sans-serif;">
                                                                        ...
                                                                        <tr>
                                                                            <td colspan="2" class="mobile-p mob-td"
                                                                                align="left"
                                                                                style="padding:10px 40px 0px 40px; font-family: 'Product sans', sans-serif;line-height: 1.5; font-weight:400;font-size:14px;">
                                                                                <p class="mobile-p" align="left"
