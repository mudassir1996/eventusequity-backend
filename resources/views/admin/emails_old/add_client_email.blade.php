    ...
    <table border="0" cellpadding="10" cellspacing="0" width="100%">
        ...
        <tr>
            ...
            background-color: #fff; overflow: hidden;border-bottom: 1px solid #E2E2E2;">
                                                        <img style=" height: 41px; margin-top:20px;margin-bottom:20px;"
                                                            alt="{{ env('APP_NAME') }}"
             ...
             font-family: 'Product sans bold;line-height: 1.5;">
                                                        <h1
                                                            ...
                                                            <span style="font-weight:500;">Hi
                                                                {{ ucfirst($client['first_name']) }}</span>
                                                        </h1>
                                                        <p class="mobile-p" align="left"
                                                            style="font-weight: 700; margin-top:20px !important;
              ...
              margin-bottom: 10px !important;font-size: 16px; color: #000;font-family: 'Product sans', sans-serif;">
                                                            Your Managed Trading Account is now setup and ready to use.
                                                        </p>
                                                        <p class="mobile-p" align="left" style="font-weight: 400; margin-top:15px;
              margin-bottom: 10px !important;font-size: 16px; color: #000;font-family: 'Product sans', sans-serif;">
             ...
             font-family: 'Product sans bold', sans-serif;line-height: 1.5;">
                                                        ...
                                                        <a class="btn-start" href="{{ route('login') }}"
                                                            style="max-width: 220px;border-radius: 6px;background-color: {{ config('email_template.primary_color') }};border:1px solid {{ config('email_template.primary_color') }};color:#fff;padding: 15px 25px;font-weight: 700;font-size:16px;">
                                                            Login to your account
                                                        </a>

                                                        <p class="mobile-p" align="left" style="font-weight: 400; margin-top:35px !important;
              margin-bottom: 10px !important;font-size: 16px; color: #000;font-family: 'Product sans', sans-serif;">
                                                            Can you make sure to change your password after you've
                                                            logged in to keep your account safe with
                                                            {{ env('APP_NAME') }}.
                                                        </p>
