										...
										class = "full-width">
											...
											<tr>
												...
												background-color: #fff; overflow: hidden;border-bottom: 1px solid #E2E2E2;">
													<img style = " height: 41px; margin-top:20px;margin-bottom:20px;" alt = "algosports" src = "{{asset('images/logo.png')}}">
												</td>
										...
										<table width = "100%" align = "center" cellspacing="0" cellpadding="20" class = "full-width">
											...
											<tr>
													...
													font-family: 'Product sans bold;line-height: 1.5;">
														<h1 style = "text-align:left;font-weight: 700; font-size:20px;color: #2AD588;font-family: 'Product sans bold', sans-serif;">
															<span style = "font-weight:500;">Hi {{ucfirst($name)}}</span>
														</h1>
											...
											<tr>
													...
													font-family: 'Product sans bold', sans-serif;line-height: 1.5;">
														<a class = "btn-start" href = "{{$url}}" style = "max-width: 220px;border-radius: 6px;background-color: #2AD588;border:1px solid #2AD588;color:#fff;padding: 15px 25px;font-weight: 700;font-size:16px;">
														Reset Password
														</a>
