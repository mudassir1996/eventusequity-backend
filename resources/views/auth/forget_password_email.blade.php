...
<head>
    ...
    <link href="{{config('email_template.font_link')}}" rel="stylesheet">
    <style type="text/css">
        a:hover {
            color: #455056;
        }
        ...
        a {
            color: {
                    {
                    config('email_template.primary_color')
                }
            }
            ...
            <td>
                <table style="background-color: #f2f3f8; max-width:650px; margin:0 auto;" width="100%" border="0"
                    ...
                    <tr>
                        <td style="text-align:center;">
                            <a href="{{config('email_template.website_link')}}" title="logo" target="_blank">
                                <img width="30%" src="{{config('email_template.logo')}}" title="logo" alt="logo">
                            </a>
                        </td>
                    </tr>
                    <tr>
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        <p style="font-size:15px; color:#455056; margin:8px 0 0; line-height:24px;">
                                            <b> Hello {{ucfirst($name)}}</b>
                                        </p><br />

                                        <h1
                                            style="color:{{config('email_template.primary_color')}}; font-weight:700; margin:0;margin-bottom:20px;font-size:22px;font-family:'Rubik',sans-serif;">
                                        ...
                                        <!-- Button -->
                                        <table bgcolor="{{config('email_template.primary_color')}}" border="0"
                                            cellpadding="0" cellspacing="0" class="wrapto100pc"
                                            style="margin: 20px auto; border-radius: 4px;">
                                            <tr>
                                                <td bgcolor="{{config('email_template.primary_color')}}" class="nomob"
                                                    style="border-top-left-radius: 8px; border-bottom-left-radius: 8px;"
                                                    width="8"></td>
                                                <td align="center" bgcolor="{{config('email_template.primary_color')}}"
                                                    class="wrapto100pc gmailbutton"
                                        ...
                                        <p
                                            ...
                                            <strong
                                                style="display: block; margin: 0 0 4px; color:rgba(0,0,0,.64); font-weight:normal;"></strong>This
                                            password
                                            reset link will expire in 60 minutes. If you did not make this request, no
                                            further action is required. You are
                                            having triuble clicking the "Reset Password" button? <a
                                                href="{{ $url }}"><b style="color: #40165D">CLICK HERE</b></a>
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <tr>
                        <td style="text-align:center;">
                            <p
                                style="font-size:14px; color:#40165D; line-height:18px; margin:0 0 0;">
                            </p>
