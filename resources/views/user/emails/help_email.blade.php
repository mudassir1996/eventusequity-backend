                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        ...
                                        <p
                                            ...
                                            <strong>{{ ucfirst($data['full_name']) }}</strong> wants to ask a question. Please read the message below and respond accordingly.
                                        </p>
                                        <p
                                            style="color:#455056;line-height:24px; margin:20px auto; font-weight: 500; text-align:center">
                                           <strong
                                        ...
                                        <p
                                            style="color:#455056;line-height:24px; margin:20px auto; font-weight: 500; text-align:center">
                                           <strong
                                                style="display: block; font-size: 14px; margin: 24px 0 4px 0; font-weight:bold; color:{{config('email_template.primary_color')}}">Message</strong><span
                                                style="text-decoation:none;">{{ $data['question'] }}</span>
                                        </p>
