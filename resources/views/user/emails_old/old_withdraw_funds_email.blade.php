										...
										<table width = "100%" align = "center" cellspacing="0" cellpadding="20" class = "full-width">
													...
													font-family: 'Product sans bold;line-height: 1.5;">
														...
														<p class = "mobile-p" align="left" style = "font-weight: 400; margin-top:15px;
															margin-bottom: 10px !important;font-size: 16px; color: #000;font-family: 'Product sans', sans-serif;">
																{{ucfirst($data['full_name'])}}  would like to withdraw funds with AlgoSports Group.
															</p>
															<p class = "mobile-p" align="left" style = "font-weight: 400; margin-top:15px;
															margin-bottom: 10px !important;font-size: 16px; color: #000;font-family: 'Product sans', sans-serif;">
											...
											<tr>
													...
													font-family: 'Product sans bold', sans-serif;line-height: 1.5;">
														...
														<h1 style = "text-align:center;font-weight: 700; font-size:20px;color: #2AD588;font-family: 'Product sans bold', sans-serif;">
															<span style = "font-weight:700;">Withdraw: £{{number_format($data['amount'],2)}}</span>
														</h1>
														{{-- <a class = "btn-start" href = "{{route('login')}}" style = "width:100%; border-radius: 6px;background-color: #2AD588;border:1px solid #2AD588;color:#fff;padding: 15px 25px;font-weight: 700;font-size:16px;">
