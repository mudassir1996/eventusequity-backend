            ...
            background-color: #fff; overflow: hidden;border-bottom: 1px solid #E2E2E2;">
             ...
             font-family: 'Product sans bold;line-height: 1.5;">
                                                        <h1
                                                            ...
                                                            <span style="font-weight:500;">Withdraw Funds Request</span>
                                                        </h1>
               ...
               margin-bottom: 10px !important;font-size: 16px; color: #000;font-family: 'Product sans', sans-serif;">
                                                            {{ ucfirst($data['full_name']) }} would like to withdraw
                                                            funds with {{ env('APP_NAME') }}.
                                                        </p>
                                                        <p class="mobile-p" align="left" style="font-weight: 400; margin-top:15px;
               margin-bottom: 10px !important;font-size: 16px; color: #000;font-family: 'Product sans', sans-serif;">
                                                        ...
                                                        <p class="mobile-p" align="left" style="font-weight: 400; margin-top:15px;
               margin-bottom: 10px !important;font-size: 16px; color: #000;font-family: 'Product sans', sans-serif;">
                                                            <b>Reason:</b> {{ $data['reason'] ?? 'Not Specified' }}
                                                        </p>
             ...
             font-family: 'Product sans bold', sans-serif;line-height: 1.5;">
                                                        ...
                                                        <h1
                                                            style="text-align:center;font-weight: 700; font-size:20px;color: {{ config('email_template.primary_color') }};font-family: 'Product sans bold', sans-serif;">
                                                            <span style="font-weight:700;">Withdraw:
                                                                £{{ number_format($data['amount'], 2) }}</span>
                                                        </h1>
                                                        {{-- <a class = "btn-start" href = "{{route('login')}}" style = "width:100%; border-radius: 6px;background-color: {{ config('email_template.primary_color') }};border:1px solid {{ config('email_template.primary_color') }};color:#fff;padding: 15px 25px;font-weight: 700;font-size:16px;">
														Withdraw: £{{number_format($data['amount'])}}
														</a> --}}
